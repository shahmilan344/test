...
class PluginFieldsRegionfieldDropdown extends CommonTreeDropdown {
   public $field_name      = "regionfield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_regionfielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_regionfielddropdowns_id`
                                                            (`plugin_fields_regionfielddropdowns_id`)
