...
class PluginFieldsSublocationfieldDropdown extends CommonTreeDropdown {
   public $field_name      = "sublocationfield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_sublocationfielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_sublocationfielddropdowns_id`
                                                            (`plugin_fields_sublocationfielddropdowns_id`)
