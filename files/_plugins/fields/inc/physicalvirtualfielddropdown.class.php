...
class PluginFieldsPhysicalvirtualfieldDropdown extends CommonTreeDropdown {
   public $field_name      = "physicalvirtualfield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_physicalvirtualfielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_physicalvirtualfielddropdowns_id`
                                                            (`plugin_fields_physicalvirtualfielddropdowns_id`)
