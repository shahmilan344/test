...
class PluginFieldsWarrantyamcfieldDropdown extends CommonTreeDropdown {
   public $field_name      = "warrantyamcfield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_warrantyamcfielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_warrantyamcfielddropdowns_id`
                                                            (`plugin_fields_warrantyamcfielddropdowns_id`)
