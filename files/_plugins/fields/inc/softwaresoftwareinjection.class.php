...
class PluginFieldsSoftwaresoftwareInjection extends PluginFieldsSoftwaresoftware implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Software::getTypeName() . " - software";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Software', 1);
