...
class PluginFieldsStandaloneinnetworkfieldDropdown extends CommonTreeDropdown {
   public $field_name      = "standaloneinnetworkfield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_standaloneinnetworkfielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_standaloneinnetworkfielddropdowns_id`
                                                            (`plugin_fields_standaloneinnetworkfielddropdowns_id`)
