...
class PluginFieldsPhysicallyexistynfieldDropdown extends CommonTreeDropdown {
   public $field_name      = "physicallyexistynfield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_physicallyexistynfielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_physicallyexistynfielddropdowns_id`
                                                            (`plugin_fields_physicallyexistynfielddropdowns_id`)
