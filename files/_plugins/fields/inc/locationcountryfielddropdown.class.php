...
class PluginFieldsLocationcountryfieldDropdown extends CommonTreeDropdown {
   public $field_name      = "locationcountryfield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_locationcountryfielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_locationcountryfielddropdowns_id`
                                                            (`plugin_fields_locationcountryfielddropdowns_id`)
